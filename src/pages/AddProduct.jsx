...
class AddProduct extends React.Component {
  ...
  sendCreate = () => {
    ...
    setTimeout(() => {
      ...
      this.props.dispatch(
        productsActions.createProductAction(body, userinfo.token)
      );
    }, 10);
  };
  componentDidUpdate(prevProps) {
    if (prevProps.product.dataCreate !== this.props.product.dataCreate)
      return this.props.navigate(
        `/product-details/${this.props.product.dataCreate.id}`
      );
  }
  imageChange = (e) => {
                    ...
                    <div className={styles["promo-details"]}>
                      ...
                      <div>
                        ...
                        <div className={styles["input-box"]}>
                          ...
                          <div className={styles["box-btn-methods"]}>
                            <p
                              className={`${styles["btn-methods"]}  ${this.state.foods}`}
                              onClick={() => {
                                this.setState({
                                  ctg_id: 1,
                                  foods: styles.select,
                            ...
                            <p
                              className={`${styles["btn-methods"]}  ${this.state.coffee}`}
                              onClick={() => {
                                this.setState({
                                  ctg_id: 2,
                                  foods: styles.nonSelect,
                            ...
                            <p
                              className={`${styles["btn-methods"]}  ${this.state.noncoffee}`}
                              onClick={() => {
                                this.setState({
                                  ctg_id: 3,
                                  foods: styles.nonSelect,
                            ...
                            <p
                              className={`${styles["btn-methods"]}  ${this.state.addons}`}
                              onClick={() => {
                                this.setState({
                                  ctg_id: 4,
                                  foods: styles.nonSelect,
