...
class AddProduct extends React.Component {
  ...
  //   getCategory = (foods, coffee, noncoffee, addons) => {
  ...
  render() {
    let foods = styles.nonSelect;
    let coffee = styles.nonSelect;
    let noncoffee = styles.nonSelect;
    let addons = styles.nonSelect;
    if (!this.props.product.isLoading) {
      if (this.props.product.ctg === "foods") foods = styles.select;
      if (this.props.product.ctg === "coffee") coffee = styles.select;
      if (this.props.product.ctg === "non coffee") noncoffee = styles.select;
      if (this.props.product.ctg === "addon") addons = styles.select;
    }
    return (
      <>
        <Header />
                          ...
                          <div className={styles["box-btn-methods"]}>
                            <p
                              className={`${styles["btn-methods"]}  ${
                                this.state.foods ? this.state.foods : foods
                              }`}
                              onClick={() => {
                                this.setState({
                                  ctg_id: 1,
                                  foods: styles.select,
                                  coffee: styles.nonSelect,
                                  noncoffee: styles.nonSelect,
                                  addons: styles.nonSelect,
                                });
                              }}
                            >
                              Foods
                            ...
                            <p
                              className={`${styles["btn-methods"]}  ${
                                this.state.coffee ? this.state.coffee : coffee
                              }`}
                              onClick={() => {
                                this.setState({
                                  ctg_id: 2,
                                  foods: styles.nonSelect,
                                  coffee: styles.select,
                                  noncoffee: styles.nonSelect,
                                  addons: styles.nonSelect,
                                });
                              }}
                            ...
                            <p
                              className={`${styles["btn-methods"]}  ${
                                this.state.addons ? this.state.addons : addons
                              }`}
                              onClick={() => {
                                this.setState({
                                  ctg_id: 4,
