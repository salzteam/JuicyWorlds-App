...
class AddPromo extends React.Component {
  ...
  componentDidMount() {
    Axios.get(
      `${process.env.REACT_APP_BACKEND_HOST}/api/v1/promo/${this.props.params.id}`
    )
      .then((result) => {
        this.setState({
  ...
  setDisplay = () => {
    if (
      ...
      this.state.dataPromo === {} &&
      !this.props.promo.newPicture
    )
      return Camera;
    if (
      !this.state.isLoading &&
      this.state.dataPromo.imagepp &&
      !this.props.promo.newPicture
    )
      return this.state.dataPromo.imagepp;
    if (
      !this.state.isLoading &&
      this.state.dataPromo.imagepp &&
      this.props.promo.newPicture
    )
      return URL.createObjectURL(this.props.promo.newPicture);
  };
  imageChange = (e) => {
    const {
      newCode,
  ...
  sendData = () => {
    ...
    Axios.patch(
      `${process.env.REACT_APP_BACKEND_HOST}/api/v1/promo/edit/${this.props.params.id}`,
      body,
      {
        headers: {
  ...
  getCategory = () => {
    if (!this.state.isLoading) {
      if (this.state.dataPromo !== {})
        return `${this.state.dataPromo.product_name}`;
      return "Loading....";
    }
    return "Loading....";
  };
              ...
              <div className="col-lg-4 text-center">
                <section className={styles["left-content"]}>
                  <div className={styles["photo-detail"]}>
                    <img
                      src={this.state.isLoading ? Camera : this.setDisplay()}
                      alt="img"
                    ...
                    <div className={`${styles["promo-details"]} `}>
                      ...
                      >
                        ...
                        <input
                          ...
                          name="code"
                          placeholder={
                            isLoading ? "Loading..." : dataPromo.code
                          }
                          onChange={(e) => {
                            const {
                              newCode,
                    ...
                    <div className={styles["promo-details"]}>
                      <div className={styles["input-box"]}>
                        ...
                        <input
                          ...
                          required
                          placeholder={
                            isLoading ? "Loading...." : dataPromo.title
                          }
                          onChange={(e) => {
                            const {
                              newCode,
                      ...
                      <div className={styles["input-box"]}>
                        ...
                        <input
                          ...
                          name="code"
                          placeholder={
                            isLoading ? "Loading...." : dataPromo.description
                          }
                          onChange={(e) => {
                            const {
                              newCode,
                      ...
                      <div className={styles["input-box"]}>
                        ...
                        <input
                          ...
                          name="code"
                          placeholder={
                            isLoading ? "Loading...." : dataPromo.discount
                          }
                          onChange={(e) => {
                            const {
                              newCode,
...
export default connect(mapStateToProps)(
  withRouteParams(withNavigate(AddPromo))
);
